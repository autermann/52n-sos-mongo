 ...
 */
class ObservedPropertyObservationFilter extends ObservationFilter {

    private String observedProperty;

    ObservedPropertyObservationFilter(String observedProperty) {
    ...
    static class ObservedPropertyFilterFunction implements Function<String, ObservationFilter> {
        @Override
