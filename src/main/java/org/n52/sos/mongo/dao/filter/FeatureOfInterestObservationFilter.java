 ...
 */
class FeatureOfInterestObservationFilter extends ObservationFilter {

    private String feature;

    FeatureOfInterestObservationFilter(String feature) {
    ...
    static class FeatureOfInterestFilterFunction implements Function<String, ObservationFilter> {
        @Override
