 ...
 */
class ObservedPropertiesFeatureFilter extends FeatureFilter {

    private String observedProperty;

    ObservedPropertiesFeatureFilter(String observedProperty) {
    ...
    static class ObservedPropertyFilterFunction implements Function<String, FeatureFilter> {
        @Override
