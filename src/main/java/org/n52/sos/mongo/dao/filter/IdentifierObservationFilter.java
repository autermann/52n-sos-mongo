 ...
 */
class IdentifierObservationFilter extends ObservationFilter {

    private String identifier;

    IdentifierObservationFilter(String identifier) {
    ...
    static class IdentifierFilterFunction implements Function<String, ObservationFilter> {
        @Override
