 ...
 */
class IdentifierFeatureFilter extends FeatureFilter {

    private String identifier;

    IdentifierFeatureFilter(String identifier) {
    ...
    static class IdentifierFilterFunction implements Function<String, FeatureFilter> {
        @Override
