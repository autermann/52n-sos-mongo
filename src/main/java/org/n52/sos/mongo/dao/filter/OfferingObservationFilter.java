 ...
 */
class OfferingObservationFilter extends ObservationFilter {

    private String offering;

    OfferingObservationFilter(String offering) {
    ...
    static class OfferingFilterFunction implements Function<String, ObservationFilter> {
        @Override
