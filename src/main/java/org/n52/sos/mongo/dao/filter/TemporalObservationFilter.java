 ...
 */
class TemporalObservationFilter extends ObservationFilter {

    private TemporalFilter filter;

    TemporalObservationFilter(TemporalFilter filter) {
        this.filter = filter;
    }
    ...
    static class TemporalFilterFunction implements Function<TemporalFilter, ObservationFilter> {
        @Override
