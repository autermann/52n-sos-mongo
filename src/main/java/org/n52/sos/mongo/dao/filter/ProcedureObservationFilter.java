 ...
 */
class ProcedureObservationFilter extends ObservationFilter {
    private String procedure;

    ProcedureObservationFilter(String procedure) {
    ...
    static class ProcedureFilterFunction implements Function<String, ObservationFilter> {
        @Override
